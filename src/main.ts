...
function main(){
    ...
    const api = ApiExpress.create([createRoute, listRoute, deleteRoute, findByIdRoute, updateRoute, createContaPagarRoute, listContaPagarRoute, updateContaPagarRoute, deleteContaPagarRoute, findByIdRouteContaPagar]);
